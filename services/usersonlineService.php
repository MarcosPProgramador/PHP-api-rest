...
class usersonlineService {
    ...
    public function get(int $id = null) {
        ...
        if ($id) {
            $query = 'SELECT * FROM `tb_admin.usersonline` WHERE id = ?';
            return \Models\serviceApiModel::select($id, $query);
        }

        $query = 'SELECT * FROM `tb_admin.usersonline`';
    ...
    public function put() {
        ...
        $query = '  UPDATE `tb_admin.usersonline`
    ...
    public function delete() {
        ...
        if ($id) {
            $query = 'DELETE FROM `tb_admin.usersonline` WHERE id = ?';
